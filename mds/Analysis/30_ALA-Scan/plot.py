...
Typical usage (run from your simulation directory):
  - Time series:
      python3 ALA-Scan/plot_timeseries.py analysis/18198196_*.dat -o ALA-Scan_18198196.png
  - Heatmaps (2D-RMSD/DCCM):
      python3 ALA-Scan/plot_heatmap.py <matrix_file> -o ALA-Scan_18198196.png
"""
