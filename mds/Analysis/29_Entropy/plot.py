...
Typical usage (run from your simulation directory):
  - Time series:
      python3 Entrophy/plot_timeseries.py analysis/18198196_*.dat -o Entrophy_18198196.png
  - Heatmaps (2D-RMSD/DCCM):
      python3 Entrophy/plot_heatmap.py <matrix_file> -o Entrophy_18198196.png
"""
