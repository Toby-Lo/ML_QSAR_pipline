...
Typical usage (run from your simulation directory):
  - Time series:
      python3 Distance/plot_timeseries.py analysis/18198196_*.dat -o Distance_18198196.png
  - Heatmaps (2D-RMSD/DCCM):
      python3 Distance/plot_heatmap.py <matrix_file> -o Distance_18198196.png
"""
