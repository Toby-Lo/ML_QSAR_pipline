...
Typical usage (run from your simulation directory):
  - Time series:
      python3 MMPBSA-GBSA/plot_timeseries.py analysis/18198196_*.dat -o MMPBSA-GBSA_18198196.png
  - Heatmaps (2D-RMSD/DCCM):
      python3 MMPBSA-GBSA/plot_heatmap.py <matrix_file> -o MMPBSA-GBSA_18198196.png
"""
