...
Typical usage (run from your simulation directory):
  - Time series:
      python3 IRED Analysis/plot_timeseries.py analysis/18198196_*.dat -o IRED Analysis_18198196.png
  - Heatmaps (2D-RMSD/DCCM):
      python3 IRED Analysis/plot_heatmap.py <matrix_file> -o IRED Analysis_18198196.png
"""
