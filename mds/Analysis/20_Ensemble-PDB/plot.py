...
Typical usage (run from your simulation directory):
  - Time series:
      python3 Ensembal/plot_timeseries.py analysis/18198196_*.dat -o Ensembal_18198196.png
  - Heatmaps (2D-RMSD/DCCM):
      python3 Ensembal/plot_heatmap.py <matrix_file> -o Ensembal_18198196.png
"""
