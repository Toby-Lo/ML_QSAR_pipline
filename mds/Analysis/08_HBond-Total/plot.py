...
Typical usage (run from your simulation directory):
  - Time series:
      python3 H-Bond-Total/plot_timeseries.py analysis/18198196_*.dat -o H-Bond-Total_18198196.png
  - Heatmaps (2D-RMSD/DCCM):
      python3 H-Bond-Total/plot_heatmap.py <matrix_file> -o H-Bond-Total_18198196.png
"""
